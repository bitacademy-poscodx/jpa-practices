...
1. DataSource 빈 설정
2. Entity Mapping: ex01.domain.Pet
...
1. Entity Mapping: ex01.domain.Pet
...
1. Entity Mapping: ex01.domain.Emaillist
...
#### 10. ex02.TestPesistenceConfig01

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig01 동일
3. application.yml
   ```
   ...
   ```
4. -Dspring.profiles.active=test01 VM 옵션으로 테스트

#### 11. ex02.TestPesistenceConfig02

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig02 동일
3. application.yml
   ```
   ...
   ```
4. -Dspring.profiles.active=test02 VM 옵션으로 테스트

#### 12. ex02.TestPesistenceConfig03

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig03 동일
3. application.yml
   ```
   ...
   ```
4. -Dspring.profiles.active=test03 VM 옵션으로 테스트

#### 13. ex02.TestPesistenceConfig04

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig04 동일
3. application.yml
   ```
   ...
   ```
4. -Dspring.profiles.active=test04 VM 옵션으로 테스트

#### 14. ex02.TestPesistenceConfig05

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig05 동일
3. application.yml
   ```
   jpa:
      properties:
   ...
   ```
4. -Dspring.profiles.active=test05 VM 옵션으로 테스트

#### 15. ex02.TestPesistenceConfig06

1. Spring Boot Auto Configuration & Fine Configuration(application.yml)
2. ex01.config.PersistenceConfig06 동일
3. application.yml
   ```
   ...
   ```
4. -Dspring.profiles.active=test06 VM 옵션으로 테스트
5. hibernate.id.new_generator_mappings의 Vendor Provider 옵션의 대체 설정이었지만 지금 이 설정은 작동 안함 (deprecated)

#### 16. ex02.TestPesistenceConfig07
...
3. Spring Boot 지원 Hiberate Auto Configuration
